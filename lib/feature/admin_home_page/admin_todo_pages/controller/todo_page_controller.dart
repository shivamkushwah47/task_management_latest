...
class TodoController extends GetxController {
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> todosnapshotu = FirebaseFirestore
      .instance
      .collection("mytask/mytask/todo")
      .where("asignee", isEqualTo: FireBase.userInfo['name'])
      .snapshots();

  Stream<QuerySnapshot<Map<String, dynamic>>> todosnapshota =
      FirebaseFirestore.instance.collection("mytask/mytask/todo").snapshots();
}
